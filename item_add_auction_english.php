...
<input type="hidden" name="ItemSellType" value="1">
    <table border="0" cellspacing="1" width=800>
        ...
        <tr>
            <td align="right" height="30">起拍价</td>
            <td height="30"><input onkeyup="this.value=this.value.replace(/\D/g,'') " onafterpaste ="this.value=this.value.replace(/\D/g,'')" type="text" name="ItemPriceMin" size="10"></td>
        </tr>
        <tr>
            <td align="right" height="30">一口价</td>
            <td height="30"><input onkeyup="this.value=this.value.replace(/\D/g,'') " onafterpaste ="this.value=this.value.replace(/\D/g,'')" type="text" name="ItemPriceMax" size="10"></td>
        </tr>
        <tr>
